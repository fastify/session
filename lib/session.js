...
module.exports = class Session {
  constructor (fastify, request, idGenerator, cookieOpts, secret, prevSession = {}) {
  ...
  regenerate (callback) {
    if (callback) {
      const session = new Session(this[fastifyKey], this[requestKey], this[generateId], this[cookieOptsKey], this[secretKey])
  ...
  reload (callback) {
    if (callback) {
      this[requestKey].sessionStore.get(this.sessionId, (error, session) => {
        this[requestKey].session = new Session(this[fastifyKey], this[requestKey], this[generateId], this[cookieOptsKey], this[secretKey], session)
  ...
  static restore (fastify, request, idGenerator, cookieOpts, secret, prevSession) {
    const restoredSession = new Session(fastify, request, idGenerator, cookieOpts, secret, prevSession)
