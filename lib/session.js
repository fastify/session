...
module.exports = class Session {
  ...
  static restore (request, idGenerator, cookieOpts, cookieSigner, prevSession, sessionId) {
    const restoredSession = new Session(request, idGenerator, cookieOpts, cookieSigner, prevSession, sessionId)
