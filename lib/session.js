...
module.exports = class Session {
  ...
  static restore (request, idGenerator, cookieOpts, cookieSigner, prevSession) {
    const restoredSession = new Session(request, idGenerator, cookieOpts, cookieSigner, prevSession)
