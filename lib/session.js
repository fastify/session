...
module.exports = class Session {
  constructor (request, idGenerator, cookieOpts, prevSession) {
    ...
    if (!this.sessionId) {
      ...
      this.encryptedSessionId = this[requestKey].signCookie(this.sessionId)
    }
  ...
  regenerate (callback) {
    if (callback) {
      const session = new Session(this[requestKey], this[generateId], this[cookieOptsKey])
  ...
  static restore (request, idGenerator, cookieOpts, prevSession) {
    const restoredSession = new Session(request, idGenerator, cookieOpts, prevSession)
